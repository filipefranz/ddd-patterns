...
import CustomerChangeAddressEvent from "../customer/customer-changed-address.event";
...
describe('Domain events tests', () => {
    ...
    it('should notify all event handlers when customer is created and address is changed', () => {
        ...
        const customerChangedAddressEvent = new CustomerChangeAddressEvent(customer);
